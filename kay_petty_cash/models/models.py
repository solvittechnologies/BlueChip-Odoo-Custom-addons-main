...
class Kay_petty_cash(models.Model):
    ...
    name= fields.Many2one('account.analytic.account',string="Project name")
    ...
    _sql_constraints = [
                     ('custodian_unique', 
                      'unique(name, custodian)',
                      'Please Choose another custodian - Custodian has to be unique per project!')
	]
