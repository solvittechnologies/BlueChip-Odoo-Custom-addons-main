...
class PurchaseOrder(models.Model):
    ...
    def _amount_all(self):
        for order in self:
            ...
            order.update({
                ...
                'total_amount_in_word': order.currency_id.amount_to_text(amount_untaxed + amount_tax)
            })
    ...
    total_amount_in_word = fields.Char("Total amount in words",store=True, readonly=True, compute='_amount_all')
...
class PurchaseOrderLine(models.Model):
    ...
    prelim_category_ids = fields.Many2one('prelims.category', string='Prelims Category')
